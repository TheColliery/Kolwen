...
- A ban on the owner's private login address in every tracked text file, as rule 12 of
  ...
  pattern that cannot fire fails the build. It does not read images or fonts, an address split across
  lines, or one obfuscated beyond those spellings.
